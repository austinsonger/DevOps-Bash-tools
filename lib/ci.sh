...
# SYSTEM_TASKDEFINITIONSURI=https://dev.azure.com/austinsonger/
# SYSTEM_TEAMFOUNDATIONCOLLECTIONURI=https://dev.azure.com/austinsonger/
# SYSTEM_TEAMFOUNDATIONSERVERURI=https://dev.azure.com/austinsonger/
# TF_BUILD=True
#
is_azure_devops(){
    if is_tfs_ci; then

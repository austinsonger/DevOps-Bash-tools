...
export GITHUB_USER=austinsonger
export TRAVIS_USER="austinsonger"
export BUILDKITE_ORGANIZATION=hari-sekhon
export SEMAPHORE_CI_ORGANIZATION=austinsonger
...
alias pll="travis_last_log.py austinsonger/nagios-plugins"

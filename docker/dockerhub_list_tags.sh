...
Example:
    ...
    ${0##*/} austinsonger/hbase


See also:

- dockerhub_show_tags.py in the DevOps Python tools repo:  https://github.com/austinsonger/DevOps-Python-tools

    ddockerhub_show_tags.py austinsonger/hbase

- Skopeo

    skopeo inspect docker://austinsonger/hbase | jq -r '.RepoTags[]'
"

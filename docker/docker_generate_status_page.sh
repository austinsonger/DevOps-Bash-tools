...
#
#   DOCKER_USER=austinsonger ./github_generate_status_docker.sh
#
...
#
#   DOCKER_USER=austinsonger ./github_generate_status_page.sh  austinsonger/hbase austinsonger/zookeeper austinsonger/nagios-plugins ...
#
#   DOCKER_USER=austinsonger ./github_generate_status_page.sh  hbase zookeeper nagios-plugins ...
...
if [ -z "$repolist" ]; then
    repolist="$(dockerhub_search.py -n 100 austinsonger | awk '/^austinsonger\/.*[[:space:]]\[OK]/{print $1}' | sort)"
fi
...
generated by \`${0##*/}\` in [austinsonger/DevOps-Bash-tools](https://github.com/austinsonger/DevOps-Bash-tools)

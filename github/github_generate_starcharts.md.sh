...
# Examples:
    ...
    Without arguments queries for all non-fork repos for your \$GITHUB_USER and iterate them up to $top_N to generate the page
        ...
        GITHUB_USER=austinsonger ./github_generate_status_page.sh
"
...
followers="$("$srcdir/github_api.sh" /users/austinsonger | jq -r .followers)"
...
[git.io/hari-starcharts](https://git.io/hari-starcharts) generated by \`${0##*/}\` in [austinsonger/DevOps-Bash-tools](https://github.com/austinsonger/DevOps-Bash-tools)
